...
function Blog() {
  return (
    <div className="w-[428px] h-auto px-6 py-12 bg-white flex flex-col justify-start items-center gap-12">
      {/* Section Title */}
      <div className="w-[249px] flex flex-col justify-center items-center gap-6">
      ...
      {/* Content */}
      <div className="w-[380px] flex flex-col gap-16">
        {/* Categories */}
        <div className="w-[336px] h-[40px] flex justify-between text-black">
        ...
        {/* Content */}
        <div className="w-[380px] h-[1,690px] flex flex-col gap-16">
          {/**Row */}
          <div className="w-[380px] h-[1,690px] flex flex-col gap-8">
